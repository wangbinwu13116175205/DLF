...
class GWNET(BaseModel):
    def __init__(self, dropout, hidden_channels, dilation_channels, \
       ...
       # self.temporaltcn2=TemporalConvLayer(kernel_size,hidden_channels,dilation_channels)
        ...
        #self.seasontrans2=TemporalTransformer(dim=hidden_channels,depth=1,heads=4,mlp_dim=dilation_channels,time_num=12,dropout=0.1,window_size=12,device=device)
