...
class BaseEngine():
    ...
    def load_savedmodel22(self, save_path):
        month=(self._args.month-1)//3*3.0+1.0
        filename = 'final_model_learning_{}_month_{}.pt'.format(self._learning_method,month)
        self._logger.info('Start train {}, load model from {}'.format(self._month+0.5,os.path.join(save_path, filename)))
        self.model.load_state_dict(torch.load(
            '/home/wbw/ICLR/DLF-2024/res/model_record/No_self/DLF/final_model_learning_online_month_4.0.pt'))
